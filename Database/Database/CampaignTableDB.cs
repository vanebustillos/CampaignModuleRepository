...
namespace CampaignModule.Database
{
    public class CampaignTableDB : ICampaignTableDB
    {
        List<Campaign> DataBase = new List<Campaign>
        {
                ...
                new Campaign() { Id = 3,Name = "Summer discounts", Type = "SUMMER", Description = "All July", Active = false},
                new Campaign() { Id = 4,Name = "Black Friday discounts", Type = "BFRIDAY", Description = "Buy all you can", Active = false}
        };
